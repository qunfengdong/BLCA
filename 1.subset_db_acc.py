...
optional.add_argument("-d", "--database", default='ftp://ftp.ncbi.nlm.nih.gov/blast/db/16SMicrobial.tar.gz',
...
def get_db_gitaxid(url,dbstr):
	...
	subprocess.call(['blastdbcmd','-entry','all','-outfmt','%a|%T','-db',dbstr+'/'+dblist,'-out',dbstr+'/'+dblist+'.ACCtaxID'])
